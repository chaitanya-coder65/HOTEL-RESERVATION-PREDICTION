...
class ModelTraining():
    ...
    def run(self):
        try:
            ...
            mlflow.set_experiment("Hotel_Reservation_Prediction_New")
            ...
            with mlflow.start_run():
                ...
                logger.info("Logging Params amd Metrics to MLFLOW")
            ...
            raise CustomException("Failed to model training pipeline",e)
